...
use Test::More tests => 16;    # adjust also number of skipped tests !
...
{
    my $res = runperl(
        switches => ["-MB::Lint -MB::Lint::Pluggable"],
        prog     =>
...
SKIP: {
    ...
    runlint 'implicit-read', '1 for @ARGV',
...
RESULT
    ...
    runlint 'bare-subs', 'sub bare(){1}; $x=[bare=>0]; $x=$y{bare}',
        <<'RESULT';
